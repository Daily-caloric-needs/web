      ...
      <div className='content__home'>
         <div className='header'>
            <div className='header__left'>
               <div className="header__nav">
                  <Logo />
                  <button onClick={() => navigate("/statistics")} className='header__button'>Дневник питания</button>
                  <button onClick={() => navigate("/report")} className='header__button'>Отчёты</button>
                  <button onClick={() => navigate("/recipes")} className='header__button'>Рецепты</button>
               </div>
               <div className='header__text'>
                  <p> Добро пожаловать! <br />
                     Дневник питания - это проект для управления образом жизни.
                     С нами вы начнёте питаться полезнее, осознаннее, здоровее!
                  </p>
         ...
         <div className='info'>
            <div className='info__container'>
               <div className='info__left'>
                  <ul> <p>Если вас беспокоят вопросы:</p>
               ...
               <div className='info__right'>
                  <ul> <p>Почему вы захотите остаться?</p>
                     <p>За 9 минут в день вы сможете:</p>
                     <li>настроить норму потребления калорий в соответствии со своими целями</li>
                     <li>понять, почему не получается сбросить или набрать вес</li>
                     <li>питаться полезно и разнообразно, как рекомендуют диетологи и нутрициологи</li>
         ...
         <div className='calories'>
            ...
            <div className='calories__info'>
               <p>Уже сейчас вы можете воспользоваться калькулятором и узнать свою норму калорий, а также посчитать,
                  сколько энергии и воды потребляете за день.</p>
               <button className='header__button'>Рассчитать норму калорий!</button>
               <p>После регистрации вам откроется доступ к сохранению личных данных и отчетам. Если записывать приемы пищи каждый день,
                  вы увидите прогресс и сможете достичь цели.</p>
            </div>
         </div>

         <div className='recipes'>
            <p>Обязательно посмотрите базу рецептов и, если захотите поделиться, добавьте свой рецепт.</p>
